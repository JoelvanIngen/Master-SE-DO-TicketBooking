...
public class PaymentResponseHandler implements RequestHandler<SQSEvent, Void> {
    ...
    private static final SfnClient sfnClient =
            SfnClient.builder().region(Region.of(System.getenv("AWS_REGION"))).build();
    ...
    public Void handleRequest(SQSEvent event, Context context) {
        for (SQSEvent.SQSMessage msg : event.getRecords()) {
            try {
                ...
                PaymentResponseMessage paymentResponse =
                        objectMapper.readValue(paymentResponseString, PaymentResponseMessage.class);
                ...
                String outputVariables =
                        objectMapper.writeValueAsString(
                                Collections.singletonMap(
                                        ProcessConstants.VAR_PAYMENT_CONFIRMATION_ID,
                                        paymentResponse.paymentConfirmationId));

                SendTaskSuccessRequest successRequest =
    ...
    public static class PaymentResponseMessage {
        ...
        public String toString() {
            return "PaymentResponseMessage [paymentRequestId="
                    + paymentRequestId
